...
if ($links.Count -eq 0) {
  $links = @("https://disk.yandex.ru/i/jr0lr00cUQp0FQ", "https://disk.yandex.ru/i/QZZ5ghsJ_w7xAg", "https://disk.yandex.ru/i/ezTOIqg1oAictA", "https://disk.yandex.ru/i/n2Ldf1ar5jbjJg", "https://disk.yandex.ru/i/WtnnnWnxsUUoZw", "https://disk.yandex.ru/i/kORWvg2JaCqGQw", "https://disk.yandex.ru/i/mzbfhA6hE_MWSA")
